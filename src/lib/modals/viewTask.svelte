<script lang="ts">
	...
	import { changeModalDetails, openModal, type IDetails } from '../../stores/modalStore';
	...
	<div class="flex w-full flex-col gap-4">
		...
		<ul class="flex w-full flex-col gap-2">
			{#each task.subtasks as subtask, subtaskIndex}
				...
				<li
					on:click={() =>
						toggleSubtask(subtaskIndex, taskIndex, boardIndex, columnIndex, subtask.isCompleted)}
